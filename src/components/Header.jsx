import { Box, Flex, Heading, NativeSelectRoot, NativeSelectField, Text, CardRoot, CardBody } from '@chakra-ui/react';
...
export default function Header() {
  ...
  return (
    <Box mb={6}>
      <Flex align="center" justify="space-between" mb={4} gap={4} direction={{ base: 'column', sm: 'row' }}>
        <Heading size="lg">{t('appTitle')}</Heading>
        <Flex align="center" gap={2}>
          <Text fontSize="sm" color="textMuted">{t('language')}:</Text>
      ...
      <Flex gap={3}>
        <CardRoot flex={1}>
          <CardBody textAlign="center">
            <Text fontSize="xs" textTransform="uppercase" letterSpacing="wide" color="textMuted" mb={1}>
              {t('totalSaved')}
            </Text>
